...
const RuleEngine = {
     ...
     */
    calculateWarningLevel(violationCount, riskLevel = null) {
    ...
    async processViolation(personId, message = 'Violation detected') {
        ...
        // Calculate new warning level - Prioritize record's risk level
        const warningLevel = this.calculateWarningLevel(newViolationCount, record.risk_level);
    ...
    async processClaimApproval(personId) {
        ...
        await CriminalRecord.deleteByPersonId(personId);
